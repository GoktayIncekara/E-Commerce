...
const Footer = () => {
  return (
    <Container>
        <Left>
            <Logo>GÖKTAY.</Logo>
            <Description>This website is created by Göktay İncekara which is a student in IZTECH</Description>
            <SocialContainer>
        ...
        <Right>
                ...
                <ContactItem>
                    <MailOutline style={{marginRight: "10px"}}/>goktayincekara@gmail.com
                </ContactItem>
